...
* **Lognormal --- rejected, by the third moment.** The lognormal has skewness
  ...
  member of the family. A second reason, independent of any moment: the
  lognormal is supported on $(0, \infty)$ and 406 of the 1000 observations are
  negative.
...
Week 01 a skewed $t$ or a generalized hyperbolic would also survive. Two
moments narrow the field; they do not pick a winner.
...
cut-off. The decay is *oscillating* rather than the geometric $\rho(k) = \beta^k$ of an AR(1); that is a hint the AR polynomial has
...
picture is not perfectly clean.
